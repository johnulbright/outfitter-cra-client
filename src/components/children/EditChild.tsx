...
class EditChild extends React.Component<EditChildProps, EditChildState> {
  ...
  handleNameOpen = () => {
    this.setState({
      newName: this.props.child.name === null ? "" : this.props.child.name,
      newUsername:
        this.props.child.username === null ? "" : this.props.child.username,
      underwearRemind:
        this.props.child.underwearRemind === null
          ? false
      ...
      <div style={{ marginBottom: "50px" }}>
        ...
        <div style={{ marginTop: "100px", marginBottom: "30px" }}>
          <Typography variant="h3">
            Editing {this.props.child.name}
            <Pencil className={classes.icon} onClick={this.handleNameOpen} />
          </Typography>
          <Link style={{ textDecoration: "none" }} to="/">
            <Button
              variant="contained"
              style={{ marginTop: "10px", backgroundColor: "#96bb7c" }}
            >
              Done
            </Button>
          </Link>
        ...
        <Paper>
          <Grid
            justify="center"
            container
            style={{ backgroundColor: "#e3dfc8", flexGrow: 2 }}
          >
            <Grid item>
            ...
            <Grid item>
              ...
              >
                <CardContent className={classes.icon}>
                  <Add fontSize="large" />
                  <GiClothes size={"2.5em"} />
                </CardContent>
              </div>
              <Dialog
                open={this.state.openNewClothes}
                onClose={this.handleCloseNewClothes}
              >
                <NewClothes
                  closeNewClothes={this.closeNewClothes}
              ...
              <ShowClothes
                setActiveClothes={this.setActiveClothes}
                setOpenClothes={this.setOpenClothes}
              ...
              <EditClothes
                clothes={this.state.activeClothes}
                setOpenClothes={this.setOpenClothes}
                getAllClothes={this.getAllClothes}
                child={this.props.child}
                sessionToken={this.props.sessionToken}
                open={this.state.openEditClothes}
              />
            </Grid>
          </Grid>
        </Paper>
