...
interface EditEventsProps extends WithStyles<typeof styles> {
  child: ChildKeys;
  sessionToken: string;
  showEdit: boolean;
}
...
class EditEvents extends React.Component<EditEventsProps, EditEventsState> {
    ...
    return (
      <div>
        <div
          ...
          onClick={() => this.setState({ openNewEvent: true })}
        >
